                            ...
                            <div class="row g-4">
                                <div class="col-lg-3 col-md-6">
                                    ...
                                    <ul class="megamenu-list">
                                        <li><a href="<?= base_url('san_pham.php?keyword=Nam') ?>"><i class="bi bi-chevron-right"></i> Áo sơ mi & Polo</a></li>
                                        <li><a href="<?= base_url('san_pham.php?keyword=Nam') ?>"><i class="bi bi-chevron-right"></i> Quần tây & Jeans</a></li>
                                        <li><a href="<?= base_url('san_pham.php?keyword=Vest') ?>"><i class="bi bi-chevron-right"></i> Vest & Blazer</a></li>
                                        <li><a href="<?= base_url('san_pham.php?keyword=Phụ kiện') ?>"><i class="bi bi-chevron-right"></i> Phụ kiện Nam</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    ...
                                    <ul class="megamenu-list">
                                        <li><a href="<?= base_url('san_pham.php?keyword=Nữ') ?>"><i class="bi bi-chevron-right"></i> Váy & Đầm dạ hội</a></li>
                                        <li><a href="<?= base_url('san_pham.php?keyword=Nữ') ?>"><i class="bi bi-chevron-right"></i> Áo kiểu & Croptop</a></li>
                                        <li><a href="<?= base_url('san_pham.php?keyword=Nữ') ?>"><i class="bi bi-chevron-right"></i> Quần & Chân váy</a></li>
                                        <li><a href="<?= base_url('san_pham.php?keyword=Túi') ?>"><i class="bi bi-chevron-right"></i> Túi xách & Giày</a></li>
                                    </ul>
                                </div>
